...
/////////////////
const BotName = 'FARREL BOT'; 
const instagram = 'https://instagram.com/farrel.a.r08?igshid=1s86zw2gknvgv'; 
const telegram = 'https://t.me/farrelabiyuromzi'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCEYdyq0NlRz4Pjy6uOct_zA';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@farrel.a.r08`)
})
